...
def display_students(search_query=''):
    ...
    df = pd.DataFrame(students, columns=["Student ID", "Name", "Gender", "Age", "Location", "Household Income", "Sports", "Academic Clubs", "Average", "Predicted Average", "Date Created", "Last Updated"])
